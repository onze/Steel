#ifndef _DYNAMIC_RENDERABLE_H
#define _DYNAMIC_RENDERABLE_H
...
/// Abstract base class providing mechanisms for dynamically growing hardware buffers.
    ...
    {
            /**
             * See http://www.ogre3d.org/tikiwiki/tiki-index.php?page=DynamicGrowingBuffers
             */
        public:
            /// Constructor
            DynamicRenderable();
